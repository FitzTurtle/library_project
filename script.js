...
const assassin5 = new Book("Fools quest", "Robert Jordan, and a bunch of other people, ", 700, true);
const assassin6 = new Book("A really long title to test some stuff, maybe even a bit longer", "Robert Jordan, and a bunch of other people, ", 700, true);
